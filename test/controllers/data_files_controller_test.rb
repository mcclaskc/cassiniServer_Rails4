...
class DataFilesControllerTest < ActionController::TestCase
  ...
  test "should create data_file" do
    assert_difference('DataFile.count') do
      post :create, data_file: { file_date: @data_file.file_date, file_type_id: @data_file.file_type_id, path: @data_file.path }
    end
  ...
  test "should update data_file" do
    patch :update, id: @data_file, data_file: { file_date: @data_file.file_date, file_type_id: @data_file.file_type_id, path: @data_file.path }
    assert_redirected_to data_file_path(assigns(:data_file))
  end
